...
class ViewController: UIViewController {
    ...
    func changeUserData(idUser: Int, userName: String, password: String, email: String) {
        let changeUserData = requestFactory.makeChangeDataUserRequsetFactory()
        changeUserData.changeUserData(idUser: idUser, userName: userName, password: password, email: email) { response in
            switch response.result {
